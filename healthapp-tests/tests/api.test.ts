...
test.describe("Health App API", () => {
  test.describe("GET /hello", () => {
    test("should return greeting message", async ({ request }) => {
      const response = await request.get(`${baseURL}/hello`);
  ...
  test.describe("GET /bmi", () => {
    test("should calculate BMI correctly", async ({ request }) => {
      const response = await request.get(`${baseURL}/bmi?height=180&weight=72`);
    ...
    test("should return error for missing height parameter", async ({
      ...
      const response = await request.get(`${baseURL}/bmi?weight=72`);
    ...
    test("should return error for missing weight parameter", async ({
      ...
      const response = await request.get(`${baseURL}/bmi?height=180`);
    ...
    test("should return error for non-numeric height", async ({ request }) => {
      const response = await request.get(`${baseURL}/bmi?height=abc&weight=72`);
    ...
    test("should return error for non-numeric weight", async ({ request }) => {
      const response = await request.get(
        `${baseURL}/bmi?height=180&weight=xyz`,
      );
  ...
  test.describe("POST /exercises", () => {
    test("should calculate exercise statistics correctly", async ({
      ...
      const response = await request.post(`${baseURL}/exercises`, {
        data: {
